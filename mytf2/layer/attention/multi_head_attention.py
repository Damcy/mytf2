...
class MultiHeadAttention(tf.keras.layers.Layer):
    ...
    def call(self, inputs, spacial_bias=None, attention_mask=None, return_attention_scores=False, training=None):
        """
        Args:
        ...
        if spacial_bias is not None:
            attention_scores = tf.multiply(attention_scores + spacial_bias,
